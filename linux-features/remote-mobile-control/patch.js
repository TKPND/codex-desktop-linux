...
const REMOTE_CONTROL_LOAD_GATE_NEEDLE =
  /function ([A-Za-z_$][\w$]*)\(\)\{return ([A-Za-z_$][\w$]*)\((?:`1042620455`|"1042620455"|'1042620455')\)\}/u;
...
function linuxDeviceKeyProviderSource({ childProcessVar, cryptoVar, fsVar, pathVar }) {
  return [
    ...
    "return{privateKeyCiphertextBase64:codexLinuxRemoteControlStorageState.safeStorage.encryptString(codexLinuxRemoteControlPrivateKeyPem).toString(`base64`),storageBackend:codexLinuxRemoteControlStorageState.detectedBackend}",
    "}",
    ...
    "if(codexLinuxRemoteControlKeyStore&&(codexLinuxRemoteControlKeyStore.version==null||codexLinuxRemoteControlKeyStore.version===1))codexLinuxRemoteControlKeyStore={version:codexLinuxRemoteControlKeyStoreVersion,keys:codexLinuxRemoteControlKeyStore.keys};codexLinuxRemoteControlKeyStore=codexLinuxRemoteControlValidateDeviceKeyStore(codexLinuxRemoteControlKeyStore);let codexLinuxRemoteControlMigratedStore={version:codexLinuxRemoteControlKeyStoreVersion,keys:{...codexLinuxRemoteControlKeyStore.keys}},codexLinuxRemoteControlMigrationNeeded=!1,codexLinuxRemoteControlStorageState=codexLinuxRemoteControlStorage();if(codexLinuxRemoteControlStorageState.safeStorage!=null)for(let [codexLinuxRemoteControlKeyId,codexLinuxRemoteControlKeyRecord] of Object.entries(codexLinuxRemoteControlMigratedStore.keys))if(typeof codexLinuxRemoteControlKeyRecord.privateKeyPkcs8Pem===`string`)try{let codexLinuxRemoteControlEncryptedFields=codexLinuxRemoteControlStorageFields(codexLinuxRemoteControlKeyRecord.privateKeyPkcs8Pem);codexLinuxRemoteControlMigratedStore.keys[codexLinuxRemoteControlKeyId]={...codexLinuxRemoteControlKeyRecord,...codexLinuxRemoteControlEncryptedFields};delete codexLinuxRemoteControlMigratedStore.keys[codexLinuxRemoteControlKeyId].privateKeyPkcs8Pem;codexLinuxRemoteControlMigrationNeeded=!0}catch{console.warn(`WARN: Could not migrate Linux remote control device key to safeStorage; retaining legacy file-backed key`)}if(codexLinuxRemoteControlMigrationNeeded)try{codexLinuxWriteRemoteControlDeviceKeyStore(codexLinuxRemoteControlMigratedStore)}catch{console.warn(`WARN: Could not persist Linux remote control device-key migration; retaining original store`)}return codexLinuxRemoteControlMigratedStore",
    "}",
    ...
    "await codexLinuxWithRemoteControlKeyStoreLock(()=>{let codexLinuxRemoteControlKeyStore=codexLinuxReadRemoteControlDeviceKeyStore();codexLinuxRemoteControlKeyStore.version=codexLinuxRemoteControlKeyStoreVersion,codexLinuxRemoteControlKeyStore.keys={...codexLinuxRemoteControlKeyStore.keys,[codexLinuxRemoteControlKeyId]:codexLinuxRemoteControlKeyRecord},codexLinuxWriteRemoteControlDeviceKeyStore(codexLinuxRemoteControlKeyStore)});",
    ...
    `signDeviceKey:async(codexLinuxRemoteControlKeyId,codexLinuxRemoteControlPayload)=>{let codexLinuxRemoteControlKeyRecord=codexLinuxReadRemoteControlDeviceKeyStore().keys?.[codexLinuxRemoteControlKeyId];if(codexLinuxRemoteControlKeyRecord==null)throw Error(\`Linux remote control device key not found\`);let codexLinuxRemoteControlSigningKey=(0,${cryptoVar}.createPrivateKey)(codexLinuxRemoteControlPrivateKeyPem(codexLinuxRemoteControlKeyRecord)),codexLinuxRemoteControlSignatureDerBase64=(0,${cryptoVar}.sign)(\`sha256\`,codexLinuxRemoteControlPayload,codexLinuxRemoteControlSigningKey).toString(\`base64\`);return{algorithm:codexLinuxRemoteControlKeyRecord.algorithm,signatureDerBase64:codexLinuxRemoteControlSignatureDerBase64}}`,
    "}}",
  ].join("");
}
